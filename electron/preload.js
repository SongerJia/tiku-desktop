...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  exportAllZip: (avatar) => ipcRenderer.invoke('exportAllZip', avatar),
  ...
  exportData: (avatar) => ipcRenderer.invoke('exportData', avatar),
  ...
  addCard: (front, back, category, subjectId, categoryId, phonetic, audioUrl) => ipcRenderer.invoke('addCard', front, back, category, subjectId, categoryId, phonetic, audioUrl),
  addCardFromQuestion: (questionId) => ipcRenderer.invoke('addCardFromQuestion', questionId),
  addCardFromHighlight: (highlightId, extra) => ipcRenderer.invoke('addCardFromHighlight', highlightId, extra),
  addCardSmart: (opts) => ipcRenderer.invoke('addCardSmart', opts),
  listCards: (opts) => ipcRenderer.invoke('listCards', opts),
  updateCard: (id, front, back, category, subjectId, categoryId, phonetic, audioUrl) => ipcRenderer.invoke('updateCard', id, front, back, category, subjectId, categoryId, phonetic, audioUrl),
  deleteCard: (id) => ipcRenderer.invoke('deleteCard', id),
  rateCard: (cardId, felt) => ipcRenderer.invoke('rateCard', cardId, felt),
  ...
  removeWrongBook: (questionId) => ipcRenderer.invoke('removeWrongBook', questionId),
