...
export const ACH_SERIES = [
  ...
  { key: 'wrong', name: '错题大师', icon: '🛡️' },
  { key: 'cards', name: '记忆卡达人', icon: '🃏' },
  { key: 'focus', name: '专注达人', icon: '⏳' },
  { key: 'quest', name: '任务达人', icon: '✅' },
...
export const ACH_DEFS = [
  ...
  { key: 'fiveK', name: '万题斩', icon: '🚀', series: 'quiz', rarity: 'platinum', desc: '累计刷题 5000 题', progress: m => m.totalAnswered / 5000, fmt: m => `${m.totalAnswered}/5000` },
  { key: 'correct500', name: '百步穿杨', icon: '🏹', series: 'quiz', rarity: 'platinum', desc: '累计答对 500 次', progress: m => m.correctCount / 500, fmt: m => `${m.correctCount}/500` },
  // ===== 连续打卡（streak）=====
  ...
  { key: 'streak60', name: '连击王者', icon: '👑', series: 'streak', rarity: 'gold', desc: '连续学习 60 天', progress: m => m.streak / 60, fmt: m => `${Math.min(m.streak, 60)}/60` },
  { key: 'streak100', name: '百日连击', icon: '🐉', series: 'streak', rarity: 'platinum', desc: '连续学习 100 天', progress: m => m.streak / 100, fmt: m => `${Math.min(m.streak, 100)}/100` },
  // ===== 掌握之路（master）=====
  ...
  { key: 'master100', name: '融会贯通', icon: '🔗', series: 'master', rarity: 'silver', desc: '掌握 100 道题', progress: m => m.mastered / 100, fmt: m => `${m.mastered}/100` },
  { key: 'master500', name: '题海宗师', icon: '🧙', series: 'master', rarity: 'platinum', desc: '掌握 500 道题', progress: m => m.mastered / 500, fmt: m => `${m.mastered}/500` },
  // ===== 错题大师（wrong）：直面错题 + 错题毕业（wrongCount / mastered）=====
  { key: 'wrong10', name: '直面错题', icon: '🛡️', series: 'wrong', rarity: 'bronze', desc: '错题本积累 10 道', progress: m => m.wrongCount / 10, fmt: m => `${m.wrongCount}/10` },
  { key: 'wrong50', name: '错题山积', icon: '⛰️', series: 'wrong', rarity: 'silver', desc: '错题本积累 50 道', progress: m => m.wrongCount / 50, fmt: m => `${m.wrongCount}/50` },
  { key: 'wrong100', name: '错题如海', icon: '🌊', series: 'wrong', rarity: 'gold', desc: '错题本积累 100 道', progress: m => m.wrongCount / 100, fmt: m => `${m.wrongCount}/100` },
  { key: 'clear100', name: '毕业百题', icon: '🎓', series: 'wrong', rarity: 'silver', desc: '从错题本毕业 100 道（掌握）', progress: m => m.mastered / 100, fmt: m => `${m.mastered}/100` },
  { key: 'clear300', name: '错题清零者', icon: '🧹', series: 'wrong', rarity: 'platinum', desc: '从错题本毕业 300 道（掌握）', progress: m => m.mastered / 300, fmt: m => `${m.mastered}/300` },
  // ===== 记忆卡达人（cards）：建卡 + 复习（cardsCount / reviewCount）=====
  { key: 'card1', name: '记忆初成', icon: '🃏', series: 'cards', rarity: 'bronze', desc: '制作第 1 张记忆卡', progress: m => m.cardsCount / 1, fmt: m => `${Math.min(m.cardsCount, 1)}/1` },
  { key: 'card10', name: '卡片新手', icon: '🎴', series: 'cards', rarity: 'silver', desc: '制作 10 张记忆卡', progress: m => m.cardsCount / 10, fmt: m => `${m.cardsCount}/10` },
  { key: 'card50', name: '记忆宫殿', icon: '🏛️', series: 'cards', rarity: 'gold', desc: '制作 50 张记忆卡', progress: m => m.cardsCount / 50, fmt: m => `${m.cardsCount}/50` },
  { key: 'card100', name: '记忆大师', icon: '🧠', series: 'cards', rarity: 'platinum', desc: '制作 100 张记忆卡', progress: m => m.cardsCount / 100, fmt: m => `${m.cardsCount}/100` },
  { key: 'cardReview200', name: '温故知新', icon: '🔁', series: 'cards', rarity: 'gold', desc: '累计复习 200 次', progress: m => m.reviewCount / 200, fmt: m => `${m.reviewCount}/200` },
  // ===== 专注达人（focus）：专注总分钟（focusMin）=====
  { key: 'focus30', name: '专注一刻', icon: '⏱️', series: 'focus', rarity: 'bronze', desc: '累计专注 30 分钟', progress: m => m.focusMin / 30, fmt: m => `${m.focusMin}/30` },
  { key: 'focus300', name: '专注五小时', icon: '🍅', series: 'focus', rarity: 'silver', desc: '累计专注 300 分钟', progress: m => m.focusMin / 300, fmt: m => `${m.focusMin}/300` },
  { key: 'focus1500', name: '专注 25 小时', icon: '⚡', series: 'focus', rarity: 'gold', desc: '累计专注 1500 分钟', progress: m => m.focusMin / 1500, fmt: m => `${m.focusMin}/1500` },
  { key: 'focus5000', name: '专注 83 小时', icon: '🔥', series: 'focus', rarity: 'platinum', desc: '累计专注 5000 分钟', progress: m => m.focusMin / 5000, fmt: m => `${m.focusMin}/5000` },
  // ===== 任务达人（quest）：习惯打卡（habitChecks）=====
  { key: 'habit5', name: '自律开端', icon: '🎬', series: 'quest', rarity: 'bronze', desc: '习惯打卡 5 次', progress: m => m.habitChecks / 5, fmt: m => `${m.habitChecks}/5` },
  { key: 'habit30', name: '习惯成自然', icon: '🌱', series: 'quest', rarity: 'silver', desc: '习惯打卡 30 次', progress: m => m.habitChecks / 30, fmt: m => `${m.habitChecks}/30` },
  { key: 'habit100', name: '铁律达人', icon: '🦾', series: 'quest', rarity: 'gold', desc: '习惯打卡 100 次', progress: m => m.habitChecks / 100, fmt: m => `${m.habitChecks}/100` },
  // ===== 知识库（kb）=====
  ...
  { key: 'kbFifty', name: '图书馆长', icon: '🏛️', series: 'kb', rarity: 'gold', desc: '导入 50 篇文档', progress: m => m.kbDocs / 50, fmt: m => `${m.kbDocs}/50` },
  { key: 'kbLink50', name: '知识网络', icon: '🕸️', series: 'kb', rarity: 'gold', desc: '建立 50 条文档↔题目联动', progress: m => m.kbLinks / 50, fmt: m => `${m.kbLinks}/50` },
  { key: 'kbRead200', name: '学富五车', icon: '🎓', series: 'kb', rarity: 'platinum', desc: '阅读文档 200 次', progress: m => m.kbReadCount / 200, fmt: m => `${m.kbReadCount}/200` },
  // ===== 笔记整理（notes）=====
  ...
  { key: 'notes100', name: '著作等身', icon: '📚', series: 'notes', rarity: 'platinum', desc: '写满 100 条笔记', progress: m => m.notesCount / 100, fmt: m => `${m.notesCount}/100` },
  { key: 'tags30', name: '标签艺术家', icon: '🎨', series: 'notes', rarity: 'gold', desc: '使用 30 个标签', progress: m => m.tagsUsed / 30, fmt: m => `${m.tagsUsed}/30` },
  // ===== 收藏卷宗（fav）=====
  ...
  { key: 'fav100', name: '藏书阁主', icon: '🏰', series: 'fav', rarity: 'platinum', desc: '收藏 100 道题', progress: m => m.favCount / 100, fmt: m => `${m.favCount}/100` },
  { key: 'favGroup5', name: '分类收藏家', icon: '🗂️', series: 'fav', rarity: 'silver', desc: '使用 5 个收藏分组', progress: m => m.favGroups / 5, fmt: m => `${m.favGroups}/5` },
  // ===== 隐藏成就（达成才揭晓）=====
